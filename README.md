...
C:\P2Oyun
|-- Resimler
|   |-- 1.jpg ... 11.jpg (Adam asmaca aşamaları)
|-- TXTDosyalar
    |-- kelimeler.txt (Oyun kelimelerinin çekildiği havuz)
    |-- log.txt (Sistem kayıtları)
    |-- oyunlar.txt (Geçmiş skorlar ve oyun verileri)
    |-- sifre.txt (Giriş şifresi)# Adam-asmaca
